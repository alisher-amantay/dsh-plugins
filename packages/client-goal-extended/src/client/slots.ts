...
export interface GoalBarActions {
  ...
  /**
   * Replace the current goal's total round cap (CAS on the projected ref).
   * @param maxGoalRounds - positive safe-integer total cap.
   */
  onSetMaxRounds: (maxGoalRounds: number) => Promise<GoalActionResult>
